...
// ── ST7789 LCD (172×320) ──────────────────────────────────────────────────────
#define LCD_CS_PIN    ((gpio_num_t)4)    // PLACEHOLDER
#define LCD_DC_PIN    ((gpio_num_t)2)    // PLACEHOLDER
#define LCD_RST_PIN   ((gpio_num_t)3)    // PLACEHOLDER
#define LCD_BL_PIN    ((gpio_num_t)5)    // PLACEHOLDER — backlight (active HIGH)
#define LCD_W         172
#define LCD_H         320
