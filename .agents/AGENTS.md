...
2. **Review Crucial Context**:
   - [Component-2 Architecture](../wiki/knowledge/architecture.md) — The four-stage pipeline, three-layer data model, and language boundary.
   - [Wiki & Session Conventions](../wiki/standards/conventions.md) — Guidelines on keeping the wiki current.
   - [Coding Standards](../wiki/standards/coding.md) — Per-language standards, TDD, strict linters, and verification checks.
   - [Data Formats](../wiki/knowledge/data-formats.md) — Raw anchor details, Zarr v2 specifications, and JSON schemas.
