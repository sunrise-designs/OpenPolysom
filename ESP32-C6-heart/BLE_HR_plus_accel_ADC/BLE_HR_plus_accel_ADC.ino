...
// I2C slave pins: XIAO ESP32-C6 D4/D5 (GPIO6=SDA, GPIO7=SCL).
// Adjust to match your wiring if using a bare C6 module.
#define I2C_SLAVE_ADDR         0x30
#define SDA_PIN                6    // XIAO ESP32-C6 SDA
#define SCL_PIN                7    // XIAO ESP32-C6 SCL

// ADC pins — GPIO1-4 are ADC1_CH1-CH4 on C6, same numbers as S3.
#define ADC_PIN                1   // GPIO1 = ADC1_CH1 — ECG
#define ACCEL_PIN_X            2   // GPIO2 = ADC1_CH2 — ADXL335 X
#define ACCEL_PIN_Y            3   // GPIO3 = ADC1_CH3 — ADXL335 Y
#define ACCEL_PIN_Z            4   // GPIO4 = ADC1_CH4 — ADXL335 Z
...
void setup() {
  // BLE requires at least 80 MHz; lower clocks caused instability with the radio stack.
